public class test {
    public static class Main {
        ...
        // To determine the currentSize of used elements in holes version, we create a loop going from the end of the array back to the beginning.
        ...
        public static int linearSearch(int element, int[] array) {
            ...
            // let n be an index in the array. Based on currentSize, n goes from index 0 and stop at the last used element to find an element
        ...
        // create a method to update element. Using the search algorithm to find the old value that we want to update
        ...
        //create a method to delete an element by shifting the rest elements to fill that position
        ...
        //create a method to delete an element by moving the last element of an array to replace it.
